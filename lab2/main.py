...
train2_path = './Train2.csv'
test1_path = './Test1.csv'
test2_path = './Test2.csv'
minst_train_samples = './TrainSamples.csv'
minst_test_samples = './TestSamples.csv'
minst_train_labels = './TrainLabels.csv'
minst_test_labels = './TestLabels.csv'
